...
public class CommandModule implements CommandExecutor, TabCompleter {
    ...
    private static class HelpCommand implements SubCommand {
        ...
        public HelpCommand(String parentCommand) {
        ...
        public void run(CommandSender sender, String[] args) {
            ...
            help.add("§bSpawnerCollectors Commands:");
    ...
    public List<String> onTabComplete(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if (subCommands.containsKey(args[0])) {
            List<String> arguments = new ArrayList<>(Arrays.asList(args.clone()));
            arguments.remove(0);
            return subCommands.get(args[0]).getCompletion(args.length - 2, arguments.toArray(new String[0]));
        }
        return null;
    }
}
